//LAB 5 
//D)
//BankAccount Class --> to define Instance variables,Instance Methods and count //variable and using this //Keyword
class BankAccount{
...
BankAccount(String Name,long Acc_no,String Acc_type,double Acc_bal){
this.Name =Name;
this.Acc_no = Acc_no;
